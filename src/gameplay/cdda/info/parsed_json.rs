...
pub(super) struct ParsedJson {
    ...
    objects_by_type: HashMap<TypeId, HashMap<ObjectId, serde_json::Map<String, serde_json::Value>>>,
}
...
fn load_ids(
    ...
    by_type: &mut HashMap<ObjectId, serde_json::Map<String, serde_json::Value>>,
    type_: &TypeId,
    json_path: &Path,
) {
