use crate::scope::gameplay_counter::GameplayCounter;
use crate::spawn::spawn_initial_entities;
...
/// This makes make [`GameplayLocal`](`crate::scope::GameplayLocal`) work, by creating and increasing a [`GameplayCounter`].
