use crate::{
    BehaviorLoopSet, BehaviorSchedule, BehaviorValidator, RefreshAfterBehavior, refresh_all,
};
...
pub(crate) fn loop_behavior_and_refresh() -> ScheduleConfigs<ScheduleSystem> {
    (
